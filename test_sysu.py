...
#################################
    ...
    queryset = TestData(query_img, query_label, transform=transform_test, img_size=(args.height, args.width))
    ...
    for trial in range(10):
        ...
        trial_gallset = TestData(gall_img, gall_label, transform=transform_test, img_size=(args.height, args.width))
